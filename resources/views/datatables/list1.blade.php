        ...
        $(function() {
            ...
            $('#posts-table').DataTable({
                ...
                "columns": [
                    ...
                    {"title": "Text", "data": "text", "name": "text", "visible": true, "searchable": true},
                    {"title": "Status", "data": "status", "name": "status", "visible": true, "searchable": true},
                    {"title": "Created_at", "data": "created_at", "name": "created_at", "visible": true, "searchable": true},
                    {"title": "Status", "data": "updated_at", "name": "updated_at", "visible": true, "searchable": true},
                    {"title": "Edit", "data": "updated_at", "name": "updated_at", "visible": true, "searchable": true},
                ],
            });
        });
